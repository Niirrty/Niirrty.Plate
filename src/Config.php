...
class Config
{
    ...
    * @param  \Niirrty\IO\Vfs\Manager|null $vfsManager Optional virtual file system manager.
    * @return \Niirrty\Plate\Config|null NULL is returned if a unknown/unsupported file format is used.
    */
   public static function FromFile( string $configFile, ?Manager $vfsManager = null ) : ?Config
   {
    ...
    * @param  \Niirrty\IO\Vfs\Manager|null $vfsManager Optional virtual file system manager.
    * @return null|\Niirrty\Plate\Config
    * @throws \Niirrty\ArgumentException
    * @throws \Niirrty\IO\FileNotFoundException
    * @throws \Niirrty\IO\IOException
    */
   public static function FromPHPFile(
      string $configFile, ?string $requiredExtension = 'php', ?Manager $vfsManager = null ) : ?Config
   {
   ...
   public static function FromJSONFile(
      string $configFile, ?string $requiredExtension = 'json', ?Manager $vfsManager = null ) : ?Config
   {
    ...
    * @param  null|string             $requiredExtension
    * @param  \Niirrty\IO\Vfs\Manager|null $vfsManager Optional virtual file system manager.
    * @return \Niirrty\Plate\Config|null
    * @throws \Niirrty\ArgumentException
    * @throws \Niirrty\IO\FileNotFoundException
    * @throws \Niirrty\IO\IOException
    */
   public static function FromINIFile(
      string $configFile, ?string $requiredExtension = 'ini', ?Manager $vfsManager = null ) : ?Config
   {
   ...
   public static function FromXMLFile(
      string $configFile, ?string $requiredExtension = 'xml', ?Manager $vfsManager = null ) : ?Config
   {
   ...
   private static function _convertXMLToConfig( \SimpleXMLElement $xml, ?Manager $vfsManager = null ) : Config
   {
